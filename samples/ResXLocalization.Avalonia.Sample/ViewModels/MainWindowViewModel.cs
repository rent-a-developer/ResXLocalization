...
using RentADeveloper.ResXLocalization.Avalonia.Sample.Models;
using RentADeveloper.ResXLocalization.Avalonia.Sample.Resources;

namespace RentADeveloper.ResXLocalization.Avalonia.Sample.ViewModels;
...
public sealed partial class MainWindowViewModel : ObservableObject, IDisposable
{
    ...
    public int[] PeopleCountOptions { get; } = [0, 1, 2, 5, 10];
    ...
    /// </summary>
    public string PoweredByViaScopedInternalManager => this.localizer.Get("PoweredBy", BrandingStrings.ResourceManager);
    ...
    public string SortOrderViaSearchAllCustomPrefix => this.localizer.Get(this.SelectedFileSortOrder, "Display_");
    ...
    public CultureInfo[] SupportedLanguages { get; } = [new("en"), new("de")];
    ...
    /// </summary>
    [ObservableProperty]
    public partial int PeopleCount { get; set; } = 5;
    ...
    partial void OnSelectedLanguageChanged(CultureInfo value) => this.localizer.CurrentCulture = value;
}
